export const MUSIC_STATIONS = [
  ...
  { id: 'dch-title', name: '🎨 Dil Chahta Hai', category: 'Bollywood Vibes', ytId: 'm1v7vI8Ldf4' },
  { id: 'gangubai-dholida', name: '💃 Dholida - Gangubai', category: 'Bollywood Vibes', ytId: 'F92mN2H0K9w' },
  { id: 'animal-satranga', name: '🐺 Satranga - Animal', category: 'Bollywood Vibes', ytId: 'S_Q0S_pX9M0' },
  { id: 'jawan-title', name: '🦁 Jawan Theme', category: 'Bollywood Vibes', ytId: 'qf_6X_YmNRE' },
  ...
  { id: 'hollywood-inception', name: '🌀 Time - Inception', category: 'Global Cinematic', ytId: 'RxabLA7yqq8' },

  // 🌸 Anime & Ghibli (YouTube)
  { id: 'ghibli-merry', name: '🎠 Merry-Go-Round - Ghibli', category: 'Anime & Ghibli', ytId: 'W9S0YvY7Kx8' },
  { id: 'jjk-kaikai', name: '🌀 Kaikai Kitan - JJK', category: 'Anime & Ghibli', ytId: 'v8bZVdTgXoY' },
  { id: 'aot-rumbling', name: '🧱 The Rumbling - AOT', category: 'Anime & Ghibli', ytId: 'OB8_6lsKIn8' },
  ...
  { id: 'cyberpunk-stay', name: '⚡ Stay At Your House', category: 'Gaming & Modern', ytId: 'KvMY1uzSCuc' },
  { id: 'modern-ocean', name: '🌊 Under the Sea', category: 'Gaming & Modern', ytId: 'la_AEFO8m7U' },
  { id: 'modern-aurora', name: '✨ Celestial Aurora', category: 'Gaming & Modern', ytId: 'YulTUVbPRaM' },
  { id: 'modern-synth84', name: '📟 Retro Synth 1984', category: 'Gaming & Modern', ytId: 'gmCbn_nezQg' },

  // 💻 Editor Ambience (YouTube)
  { id: 'dracula-focus', name: '🦇 Gothic Dracula Lofi', category: 'Editor Ambience', ytId: 'mNwQhmfkC44' },
  { id: 'onedark-focus', name: '🌌 One Dark Space', category: 'Editor Ambience', ytId: 'nFlaXrplHfs' },
  { id: 'nord-focus', name: '❄️ Arctic Nord Ambient', category: 'Editor Ambience', ytId: 'j5_WAikd1wI' },
  { id: 'tokyo-focus', name: '🏮 Tokyo Night Pop', category: 'Editor Ambience', ytId: 'lN8tzA_Omd0' },
  { id: 'catppuccin-focus', name: '🐾 Catppuccin Cafe', category: 'Editor Ambience', ytId: 'iiJ0R_lpsss' },
...
/** * Music Configuration * You can add your favorite YouTube videos or direct MP3 links here. */